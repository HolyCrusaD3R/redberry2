...
import avatar from "../assets/male_avatar.webp";
...
const TaskCard = ({
  ...
  return (
    <div
      className="mt-[30px] max-w-[381px] h-[240px] border-[1px] border-solid rounded-[15px] p-[20px]"
      style={{ borderColor }}
    >
      <div className="flex flex-col h-full">
        {/* Top section - Priority and date */}
        <div className="flex flex-row justify-between">
          <div className="flex flex-row gap-[10px]">
            ...
            >
              <p className="text-[12px] font-firago font-normal text-center">
        ...
        <div className="my-[20px] mx-[10.5px] flex-grow">
          <p className="font-firago font-medium text-[15px] mb-[12px] break-words whitespace-normal overflow-hidden text-ellipsis line-clamp-1">
            {task.name}
          </p>
          <p className="font-firago text-[14px] break-words whitespace-normal overflow-hidden text-ellipsis line-clamp-3">
        ...
        <div className="w-full flex flex-row justify-between mt-auto">
          <img
            src={task.employee?.avatar || avatar}
            alt="Employee avatar"
            className="rounded-full w-[31px] h-[31px] object-cover"
          />
          <div className="flex flex-row justify-between gap-[2.5px] items-center">
